...
function neovim.require(package, --[[optional]] settings, --[[optional]]
                        on_vscode)
    on_vscode = on_vscode or false
    settings = settings or {}

    if neovim.is_vscode() and on_vscode == false then return end
...
function neovim.read_package_json() return neovim.read_json_file 'package.json' end
